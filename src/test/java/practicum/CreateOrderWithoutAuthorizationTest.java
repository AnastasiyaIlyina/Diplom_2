...
public class CreateOrderWithAuthorizationTest {
    ...
    public void orderCanBeCreated() {
        Response response =  orderCreator.createOrder(accessToken, new String[]{"61c0c5a71d1f82001bdaaa6d", "61c0c5a71d1f82001bdaaa6e", "61c0c5a71d1f82001bdaaa72"});
...
//    }
    ...
    public void orderCannotBeCreatedWithoutIngredients() {
        Response response =  orderCreator.createOrder(accessToken, new String[]{});
    ...
    public void orderCannotBeCreatedWithWrongIngredients() {
        Response response =  orderCreator.createOrder(accessToken, new String[]{"10", "20", "30"});
